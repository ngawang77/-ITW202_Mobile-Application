...
public class ExampleUnitTest {
    ...
    public void MulTwoNumber(){
        double result = cal.mul(3d, 3d);
        assertThat(result, is(equalTo(9d)));
    }

    @Test
    public void MulTwoNumbersZero(){
        double result = cal.mul(0d, 3d);
        assertThat(result, is(equalTo(0d)));
    }

    @Test
    public void DivTwoNumber(){
        double result = cal.div(3d, 3d);
        assertThat(result, is(equalTo(1d)));
    }

    @Test
    public void DivTwoNumbersZero(){
        double result = cal.div(3d, 0d);
